...
'<p class="small silver">Made by the canCode web development team</p>' + '<p class="small silver">Current website dev team: Semyon Baykovm, Eva Gottsfield, Logan Albala, Aditya Arora, Maximilian Meiler, and Jacob Ryabinky</p>' + '</div>' +
